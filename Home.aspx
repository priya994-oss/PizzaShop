<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="PizzaShop.Home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="row slider-text align-items-center" data-scrollax-parent="true">
                    ...
                    <div class="col-md-6 col-sm-12 ftco-animate">
                        ...
                        <p>
                            ...
                            <a href="#hotpizzamenu" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a>
                        </p>
                    </div>
            ...
            <div class="container">
                <div class="row slider-text align-items-center" data-scrollax-parent="true">
                    ...
                    <div class="col-md-6 col-sm-12 order-md-last ftco-animate">
                        ...
                        <h1 class="mb-4">
                            <asp:Label ID="lblPizzaName" runat="server" /></h1>
                        <p class="mb-4 mb-md-5">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                        <p>
                            <a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a>
                            <a href="#hotpizzamenu" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a>
    ...
    OUR MENU PRICING<section class="ftco-section">
        <div class="container" id="hotpizzamenu">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <div class="row no-gutters d-flex">
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="services-wrap d-flex">
                        ...
                        <div class="text p-4">
                            <h3>
                                <asp:Label ID="lblItalianPizza" runat="server" />
                            </h3>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia </p>
                            <p class="price">
                                <span>
                                    <asp:Label ID="lblIPPrice" runat="server" />&nbsp; Rs</span>
                                <%--<a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a>--%>
                                <asp:Button ID="btnAddCart" runat="server" Text="Add Cart" CssClass="ml-2 btn btn-white btn-outline-white" OnClick="btnAddCart_Click"/>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="services-wrap d-flex">
                        ...
                        <div class="text p-4">
                            <h3>
                                <asp:Label ID="lblGreekPizza" runat="server" />
                            </h3>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
                            <p class="price">
                                <span>
                                    <asp:Label ID="lblGPPrice" runat="server" />&nbsp; Rs</span>
                                <%--<a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a>--%>
                                <asp:Button ID="btnAddCart1" runat="server" Text="Add Cart" CssClass="ml-2 btn btn-white btn-outline-white" OnClick="btnAddCart1_Click" />
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="services-wrap d-flex">
                        ...
                        <div class="text p-4">
                            <h3>
                                <asp:Label ID="lblCaucasianPizza" runat="server" />
                            </h3>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
                            <p class="price">
                                <span>
                                    <asp:Label ID="lblCPPrice" runat="server" />&nbsp; Rs</span>
                                <%--<a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a>--%>
                                <asp:Button ID="btnAddCart2" runat="server" Text="Add Cart" CssClass="ml-2 btn btn-white btn-outline-white" OnClick="btnAddCart2_Click" />
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="services-wrap d-flex">
                        ...
                        <div class="text p-4">
                            <h3>
                                <asp:Label ID="lblAmericanPizza" runat="server" />
                            </h3>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia </p>
                            <p class="price">
                                <span>
                                    <asp:Label ID="lblAPPrice" runat="server" />&nbsp; Rs</span>
                                <%--<a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a>--%>
                                <asp:Button ID="btnAddCart3" runat="server" Text="Add Cart" CssClass="ml-2 btn btn-white btn-outline-white" OnClick="btnAddCart3_Click" />
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="services-wrap d-flex">
                        ...
                        <div class="text p-4">
                            <h3>
                                <asp:Label ID="lblTomatoePie" runat="server" />
                            </h3>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
                            <p class="price">
                                <span>
                                    <asp:Label ID="lblTPPrice" runat="server" />&nbsp; Rs</span>
                                <%--<a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a>--%>
                                <asp:Button ID="btnAddCart4" runat="server" Text="Add Cart" CssClass="ml-2 btn btn-white btn-outline-white" OnClick="btnAddCart4_Click" />
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="services-wrap d-flex">
                        ...
                        <div class="text p-4">
                            <h3>
                                <asp:Label ID="lblMargherita" runat="server" />
                            </h3>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
                            <p class="price">
                                <span>
                                    <asp:Label ID="lblMPPrice" runat="server" />&nbsp;
                                Rs</span>
                                <%--<a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a>--%>
                                <asp:Button ID="btnAddCart5" runat="server" Text="Add Cart" CssClass="ml-2 btn btn-white btn-outline-white" OnClick="btnAddCart5_Click" />
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div class="menu-wrap">
                                                ...
                                                <div class="text">
                                                    ...
                                                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                                    <p class="price"><span>399 Rs</span></p>
